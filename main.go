...
func main() {
	...
	goalMakeHandler.HandleRequest(storageVolume.VolumeCreate, "/storage-volume/create")
	goalMakeHandler.HandleRequest(storageVolume.VolumeDelete, "/storage-volume/delete")
